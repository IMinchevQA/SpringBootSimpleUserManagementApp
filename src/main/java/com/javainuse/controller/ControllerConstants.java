...
public class ControllerConstants {
    ...
    public static final String CHANGE_EMPLOYEE_STATUS_URL = "/employees/change_status/{employee_id}";
    ...
    public static final String CHANGE_EMPLOYER_STATUS_URL = "/employers/change_status/{employer_id}";
